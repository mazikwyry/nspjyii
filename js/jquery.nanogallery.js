  ...
  function nanoGALLERY() {
    ...
    */
    ...
    G.picasa = {
      ...
      nanogpURL: 'https://nanogp2-nspj.herokuapp.com/index.php',
      thumbSize:64,
  ...
  //      newItem.thumbSizes=sizes;
    ...
    function PicasaProcessItems( albumIdx, processLocationHash, imageID, setLocationHash ) {
      ...
      if( G.I[albumIdx].GetID() == 0 ) {
        ...
        //nanogp
        url=G.picasa.nanogpURL + '?nguserid='+G.O.userID+'&alt=json&v=3&kind=album&thumbsize='+thumbSizes+'&rnd=' + (new Date().getTime());
      }
      else {
        // photos
        var opt='';
        ...
        url=G.picasa.nanogpURL + '?nguserid='+G.O.userID+'&ngalbumid='+G.I[albumIdx].GetID()+'&alt=json&v=3&kind=photo&thumbsize='+thumbSizes+'&rnd=' + (new Date().getTime());
...
//      })
    ...
    function PicasaParseData( albumIdx, data, kind ) {
      ...
      jQuery.each(source, function(i,data){
        if( kind == 'image')
            console.log(data.media$group.media$content);
        //Get the title
        ...
        if(data.media$group.media$content[1] != undefined)
            var videoStream = data.media$group.media$content[1].url;
        if(data.media$group.media$content[2] != undefined)
            var videoStream = data.media$group.media$content[2].url;
        ...
        if( ok ) {
          ...
          var newItem= NGAddItem(itemTitle, itemThumbURL, src, itemDescription, '' , kind, tags, itemID, albumID, videoStream );
    ...
    function NGAddItem(title, thumbSrc, imageSrc, description, destinationURL, kind, tags, ID, albumID, videoURL ) {
...
//        ch='';
    ...
    function OpenInternalViewer( imageIdx ) {
      ...
      var videoUrl = 'video=';
      if(G.I[imageIdx].videoURL != undefined){
        videoUrl += '"'+G.I[imageIdx].videoURL+'"';
      }
      sImg+='<img class="image nGEvent dupa" src="'+G.I[imageIdx].responsiveURL()+'" alt=" " style="visibility:visible;opacity:0;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;zoom:1;" itemprop="contentURL"'+videoUrl+'>';
      sImg+='<img class="image nGEvent dupa" src="'+G.I[imageIdx].responsiveURL()+'" alt=" " style="visibility:visible;opacity:0;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;zoom:1;" itemprop="contentURL"'+videoUrl+'>';
      sImg+='<img class="image nGEvent dupa" src="'+G.I[imageIdx].responsiveURL()+'" alt=" " style="visibility:visible;opacity:0;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;zoom:1;" itemprop="contentURL"'+videoUrl+'>';
...
// sImg+='<img class="image nGEvent" src="" alt=" " style="background-image:url('+G.I[imageIdx].responsiveURL()+');visibility:visible;opacity:0;position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;zoom:1;" itemprop="contentURL">';
    ...
    function DisplayInternalViewerComplete( imageIdx, displayType ) {
      ...
      if(G.I[GetNextImageIdx(imageIdx)].videoURL != undefined){
        G.$E.vwImgN.attr('video', G.I[GetNextImageIdx(imageIdx)].videoURL);
      }else{
        G.$E.vwImgN.attr('video', '');
      }
      ...
      if(G.I[GetPreviousImageIdx(imageIdx)].videoURL != undefined){
        G.$E.vwImgP.attr('video', G.I[GetPreviousImageIdx(imageIdx)].videoURL);
      }else{
        G.$E.vwImgP.attr('video', '');
      }
      ...
      G.$E.vwImgC.on("click",function(e){
        ...
        if(videoURL != undefined && videoURL != ''){
          G.$E.vwContent.prepend('<video width="'+G.$E.vwImgC.width()+'" height="'+G.$E.vwImgC.height()+'" controls id="videoPlayer"><source src="'+videoURL+'" type="video/mp4">Your browser does not support the video tag.</video>');
          $('#videoPlayer')[0].play();
        }
      });
