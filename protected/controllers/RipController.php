...
class RipController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('Rip');
	...
	{
		$model=new Rip('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rip']))
			$model->attributes=$_GET['Rip'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rip-form')
		{
